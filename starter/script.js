...
const account2 = {
  ...
  movementsDates: [
    ...
    '2023-11-12T14:43:26.374Z',
    '2023-11-14T18:49:59.371Z',
    '2023-11-15T12:01:20.894Z',
  ],
  currency: 'USD',
  locale: 'en-US',
};
...
const starLogOutTimer = function () {
  const tick = function () {
    ...
    // In each call, pint the remaining time to UI
...
//   const now = new Date();
//   console.log(now.getHours(), now.getMinutes(), now.getSeconds()), 1000;
// });
